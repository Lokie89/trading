...
public class SimulatorTest {
    ...
    void simulateTest() {
        ...
        final UpbitTradeResourceResponse buyTradeResource = UpbitTradeResourceResponse.builder(TradeType.BUY, TradeStrategy.LOWER_BOLLINGERBANDS, UpbitUnit.MINUTE_THREE).build();
        final UpbitTradeResourceResponse sellTradeResource = UpbitTradeResourceResponse.builder(TradeType.SELL, TradeStrategy.HIGHER_BOLLINGERBANDS, UpbitUnit.MINUTE_THREE).build();
