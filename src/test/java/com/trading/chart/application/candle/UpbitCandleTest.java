...
public class UpbitCandleTest {
    ...
    void getCandlesWithTime() {
        ...
        final String market = "KRW-BTC";
        CandleRequest threeMinLastTimeCandleRequest = UpbitCandleRequest.builder(unit, market).to(time).build();
    ...
    void getCandlesWithTimeAndCount() {
        ...
        CandleRequest threeMinLastTimeCandleRequest = UpbitCandleRequest.builder(unit, market).to(time).count(count).build();
